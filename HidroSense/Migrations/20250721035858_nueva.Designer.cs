...
namespace HidroSense.Migrations
{
    ...
    [Migration("20250721035858_nueva")]
    partial class nueva
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HidroSense.Models.ComponentesSistema", b =>
                {
                    ...
                    b.Property<int>("SistemaPurificacionIdSistema")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SistemaPurificacionIdSistema");
            ...
            modelBuilder.Entity("HidroSense.Models.ComponentesSistema", b =>
                {
                    ...
                    b.HasOne("HidroSense.Models.SistemaPurificacion", "SistemaPurificacion")
                        .WithMany()
                        .HasForeignKey("SistemaPurificacionIdSistema")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
